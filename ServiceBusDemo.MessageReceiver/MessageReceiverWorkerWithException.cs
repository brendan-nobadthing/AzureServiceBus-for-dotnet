...
public class MessageReceiverWorkerWithException : BackgroundService
{
    private readonly ILogger<MessageReceiverWorker> _logger;
    private readonly ServiceBusClient _serviceBusClient;

    public MessageReceiverWorkerWithException(ILogger<MessageReceiverWorker> logger, ServiceBusClient serviceBusClient)
    {
        _logger = logger;
